...
exports.frequency = exports.FrequencyArbitrary = void 0;
...
class FrequencyArbitrary extends Arbitrary_1.Arbitrary {
    ...
    enrichShrinkable(mrng, shrinkable) {
        ...
        return new Shrinkable_1.Shrinkable(shrinkable.value_, () => {
            return Stream_1.Stream.of(getItemShrinkableForFirst()).join(shrinkable.shrink());
        });
    }
}
